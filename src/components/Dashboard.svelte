<script lang="ts">
	...
	import { SYNC, VOLT } from '../lib/icons'
		...
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="flex h-16 justify-between">
				...
				<div class="hidden sm:ml-6 sm:flex sm:items-center">
					...
					<button
						type="button"
						class="rounded-full p-3 text-dark-500 hover:text-dark-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
						<Icon name="{SYNC}" fill />
					</button>
					<div class="h-6 w-px bg-dark-500 lg:hidden" aria-hidden="true"></div>
					<!-- ! HERE -->
					<!-- Profile dropdown -->
