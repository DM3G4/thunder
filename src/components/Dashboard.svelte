<script lang="ts">
	...
	import { SYNC, VOLT, USER, MENU, CLOSE, SYNC_DONE, SETTINGS, SIGN_OUT } from '../lib/icons'
	import Separator from './Separator.svelte'
	import Transition from 'svelte-class-transition'
	import { clickOutside } from '../lib/customEvents'
		...
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="flex h-16 justify-between">
				...
				<div class="hidden sm:ml-6 sm:flex sm:items-center">
					...
					<!-- TODO: Remove duplicated sync button -->
					<button
						type="button"
					...
					<div class="relative ml-3">
						...
						<Transition
							...
							<div
								...
								<!-- TODO: Remove duplcated dropdown options -->
								<a
									href="/"
									class="flex justify-between px-4 py-2 text-sm text-dark-800 font-semibold hover:bg-dark-200 hover:border-l-2  border-white"
									role="menuitem"
									tabindex="-1">Settings <Icon name="{SETTINGS}" size="{20}" class="text-dark-600" /></a>
								<a
									href="/"
									class="flex justify-between px-4 py-2 text-sm text-dark-800 font-semibold hover:bg-dark-200 hover:border-l-2 border-white"
									role="menuitem"
									tabindex="-1">Sign out <Icon name="{SIGN_OUT}" size="{20}" class="text-dark-600" /></a>
							</div>
						</Transition>
					</div>
				</div>
			...
			<div class="sm:hidden" id="mobile-menu">
				...
				<div class="border-t border-dark-border pt-4 pb-3">
					<div class="flex items-center px-4">
						...
						<!-- TODO: Remove duplicate sync action -->
						<button
							type="button"
					...
					<!-- TODO: Remove duplicate dropdown options -->
					<!-- TODO: Implement options actions -->
					<div class="mt-3 space-y-1">
						<a
							href="/"
							class="block pl-3 pr-4 py-2 text-base font-medium text-dark-500 hover:bg-dark-300 hover:text-dark-900 hover:border-dark-900 border-transparent border-l-4"
							>Settings</a>
